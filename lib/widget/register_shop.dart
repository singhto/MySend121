...
import 'package:foodlion/scaffold/shop_register_success.dart';
...
class _RegisterShopState extends State<RegisterShop> {
  ...
  double lat, lng;
  File file;
  String name, user, password, urlImage, phone;
  ...
  Future<void> insertDtaToMySQL(String string) async {
    ...
    String urlAPI =
        '${MyConstant().urlAddUserShopInfo}?isAdd=true&Name=$name&User=$user&Password=$password&UrlShop=$urlImage&Lat=$lat&Lng=$lng&PhoneShop=$phone';
        ...
        (response) {
          if (response.toString() == 'true') {
            MaterialPageRoute route = MaterialPageRoute(
              builder: (value) => ShopRegisterSuccess(),
            );
